...
<div x-data="laracrateDropzone({presignUrl:@js(route('laracrate.uploads.presign')),disk:@js($disk),fileableType:@js($fileableType),fileableId:@js($fileableId),collection:@js($collection),maxSizeKb:@js($maxSizeKb),persistQueue:false,autoStart:true,maxFiles:1})"
    ...
    @else
        ...
        <div x-show="uploading || queue.length > 0" x-cloak class="flex items-center gap-4 p-4 rounded-2xl bg-white/80 backdrop-blur-xl ring-1 ring-black/5">
