...
>
    ...
    @else
        ...
        <div x-show="uploading || queue.length > 0" x-cloak class="flex items-center gap-4 p-4 rounded-[10px] border border-t-2 border-t-[#C15F3C] border-[#1A1A1A]/[0.12] bg-[#FAF9F5]">
