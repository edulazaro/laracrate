...
>
        ...
        <div
            ...
            <div class="aspect-square bg-white/20 relative">
                ...
                <div x-show="over" x-cloak class="absolute inset-0 bg-purple-500/30 backdrop-blur-md flex items-center justify-center">
                    <p class="text-sm font-semibold text-white drop-shadow">{{ __('laracrate::uploader.drop_to_replace') }}</p>
                </div>
            </div>
            <div class="p-3">
    ...
    @else
        <div
            ...
            <p class="text-sm font-semibold text-gray-900 drop-shadow-sm">{{ __('laracrate::uploader.drag_or_click') }}</p>
