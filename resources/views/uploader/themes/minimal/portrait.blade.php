...
>
        ...
        <div
            ...
            <div class="aspect-square bg-gray-50 relative">
                ...
                <div x-show="over" x-cloak class="absolute inset-0 bg-blue-500/20 flex items-center justify-center">
                    <p class="text-xs text-blue-700">Suelta para reemplazar</p>
                </div>
            </div>
            <div class="border-l-2 border-blue-500 bg-white pl-3 py-2 mt-2">
                ...
                <div class="mt-2 flex gap-3 text-xs">
                    ...
                    <button type="button" wire:click="delete" wire:confirm="Borrar?" class="text-gray-500 hover:text-red-600 hover:underline">borrar</button>
                </div>
            </div>
    ...
    @else
        <div
            ...
            <p class="text-sm text-gray-700">Arrastra o haz clic</p>
