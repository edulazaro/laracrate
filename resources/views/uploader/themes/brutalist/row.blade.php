...
>
    @if($file)
        <div
            ...
            <div class="flex-1 min-w-0">
                ...
                @endif
                <p class="mt-1 text-[10px] font-mono uppercase tracking-[0.2em] text-neutral-400" x-show="!over">Arrastra o haz clic en reemplazar</p>
                <p class="mt-1 text-[10px] font-mono uppercase tracking-[0.2em] text-neutral-900 font-bold" x-show="over" x-cloak>Suelta para reemplazar</p>
            </div>
            ...
            <div wire:loading wire:target="upload" class="absolute -mt-1 text-[10px] font-mono uppercase tracking-[0.2em] text-neutral-700">Subiendo...</div>
        </div>
    ...
    @else
        <div
            ...
            <p class="mt-1 text-sm text-neutral-950 font-bold">Arrastra un archivo o haz clic</p>
