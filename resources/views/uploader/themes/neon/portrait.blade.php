...
>
        ...
        <div
            ...
            <div class="aspect-square bg-neutral-900 relative">
                ...
                <div x-show="over" x-cloak class="absolute inset-0 bg-cyan-500/40 flex items-center justify-center">
                    <p class="text-xs font-mono uppercase tracking-[0.25em] font-bold text-white drop-shadow-[0_0_8px_rgba(34,211,238,0.8)]">Suelta para reemplazar</p>
                </div>
            </div>
    ...
    @else
        <div
            ...
            <p class="text-sm font-bold text-white">Arrastra o haz clic</p>
