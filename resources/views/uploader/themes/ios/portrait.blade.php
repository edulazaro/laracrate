<div
        ...
        <div
            ...
            <div class="aspect-square bg-gray-100 relative">
                ...
                <div x-show="over" x-cloak class="absolute inset-0 bg-blue-500/40 backdrop-blur-md flex items-center justify-center">
                    <p class="text-[15px] font-medium text-white">{{ __('laracrate::uploader.drop_to_replace') }}</p>
                </div>
            </div>
            <div class="p-3">
    ...
    @else
        <div
            ...
            <p class="text-[15px] font-medium text-gray-900">{{ __('laracrate::uploader.drag_or_click') }}</p>
