...
>
    ...
    @else
        ...
        <div
            ...
            <p class="text-sm text-gray-700 font-medium">Arrastra un archivo o haz clic</p>
            <p class="mt-0.5 text-xs text-gray-500">Máx. {{ number_format($maxSizeKb / 1024, 1) }} MB</p>
