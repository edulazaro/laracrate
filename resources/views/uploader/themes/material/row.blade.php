...
>
    ...
    @else
        <div
            ...
            <p class="text-sm font-medium text-gray-900">Arrastra un archivo o haz clic</p>
            ...
            <div wire:loading wire:target="upload" class="mt-3 text-xs text-indigo-600 font-medium">Subiendo...</div>
        </div>
