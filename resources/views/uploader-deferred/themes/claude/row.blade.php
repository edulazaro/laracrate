    ...
    @if($state === 'staged')
        <div class="flex items-center gap-4 rounded-[10px] border border-[#C15F3C]/40 border-t-2 border-t-[#C15F3C] bg-[#FAF9F5] p-4 shadow-[0_8px_24px_rgba(26,26,26,0.06),0_2px_6px_rgba(26,26,26,0.04)]">
            @if($pendingPreviewUrl)
                <img src="{{ $pendingPreviewUrl }}" alt="" class="h-14 w-14 rounded-md object-cover border border-[#1A1A1A]/[0.08] shrink-0" />
            @else
            ...
            <div class="flex-1 min-w-0">
                <p class="text-[12px] text-[#C15F3C]">Pendiente de subir</p>
    ...
    @else
        <div
            ...
            <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                    <p class="text-[15px] text-[#1A1A1A] font-semibold">Seleccionar archivo</p>
