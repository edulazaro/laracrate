...
>
        ...
        <div>
            ...
            <div class="border-l-2 border-gray-900 bg-white pl-3 py-2 mt-2">
                ...
                <div class="mt-2 flex gap-3 text-xs">
                    ...
                    <button type="button" wire:click="cancel" class="text-gray-500 hover:text-gray-900 hover:underline">cancelar</button>
                </div>
            </div>
        </div>
    ...
    @elseif($file)
        <div>
            ...
            <div class="border-l-2 border-blue-500 bg-white pl-3 py-2 mt-2">
                ...
                <div class="mt-2">
                    <button type="button" wire:click="delete" wire:confirm="Borrar?" class="text-xs text-gray-500 hover:text-red-600 hover:underline">borrar</button>
                </div>
            </div>
        </div>
    ...
    @else
        <div
            ...
            <p class="mt-1 text-xs text-gray-400">Máx. {{ number_format($maxSizeKb / 1024, 1) }} MB</p>
